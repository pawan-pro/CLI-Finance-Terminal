...
def load_latest_data():
    try:
        with open('/Users/pawan/CLI-Finance-Terminal/approach 2.0/data/latest_market_data.pkl', 'rb') as f:
...
def save_analysis_results(latest_data, metrics, summary):
    ...
    output_path = '/Users/pawan/CLI-Finance-Terminal/approach 2.0/data/market_analysis_results.pkl'

...
def process_event(event, date_time_inputs, event_data_list, event_symbols):
    ...
    for idx, date_str in enumerate(event_dates):
        ...
        try:
            ...
            # Extended time range
            start_time = event_time - timedelta(hours=2)  # Extended further #time #period #window #9 for Equities
            end_time = event_time + timedelta(hours=2)    # Extended further #time #period #window #24 for Equities
